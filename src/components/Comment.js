const Comment = ({ title, content, image }) => (
  <div className="flex gap-3 lg:gap-4 w-full sm:w-1/2 lg:w-1/5 shrink-0 bg-neutral-800 rounded-xl p-4">
    <img className="w-8 lg:w-12 h-8 lg:h-12 rounded-lg lg:rounded-xl" src={ image } alt={ title } />
    <div>
