  ...
  <div className="relative md:translate-y-1/2 mb-12 md:mb-48">
    <div className="md:absolute md:flex justify-center w-full top-0 md:-translate-y-full">
      <div className="flex justify-center items-center gap-3 bg-neutral-50 rounded-t-2xl p-3">
        <button className="bg-neutral-700 hover:bg-neutral-800 focus:bg-neutral-800 focus:outline-none focus:ring-4 focus:ring-neutral-700 w-full md:w-auto rounded-lg md:rounded-xl text-xs md:text-sm text-neutral-50 font-medium px-4 py-1.5 md:px-8 md:py-3">Buy</button>
        <button className="focus:outline-none focus:ring-4 focus:ring-neutral-200 w-full md:w-auto rounded-lg md:rounded-xl text-xs md:text-sm text-neutral-800 font-medium px-4 py-1.5 md:px-8 md:py-3">Sell</button>
        <button className="focus:outline-none focus:ring-4 focus:ring-neutral-200 w-full md:w-auto rounded-lg md:rounded-xl text-xs md:text-sm text-neutral-800 font-medium px-4 py-1.5 md:px-8 md:py-3">Rent</button>
      </div>
    </div>
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 bg-neutral-50 w-full rounded-2xl rounded-t-none md:rounded-t-2xl text-start md:text-center p-6 pt-0 md:p-12">
      ...
      <button className="bg-emerald-500 hover:bg-emerald-600 focus:bg-emerald-600 focus:outline-none focus:ring-4 focus:ring-emerald-500 w-full md:w-auto rounded-lg md:rounded-xl text-xs md:text-sm text-neutral-50 font-medium px-4 py-2 md:px-8 md:py-4">Search</button>
    </div>
