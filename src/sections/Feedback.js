...
const Feedback = () => (
  <section className="pt-12 lg:pt-24">
    <div className="container mx-auto px-6 lg:px-0">
      <h2 className="text-xl md:text-3xl lg:text-4xl text-neutral-50 font-medium leading-tight md:leading-snug">Thousand Of <br /> Statisfied ─ Customers</h2>
    </div>
    <div className="relative flex flex-col gap-3 lg:gap-6 mt-6 lg:mt-12">
      ...
      <div className="flex justify-center gap-3 lg:gap-6 px-6 md:px-0 overflow-hidden">
